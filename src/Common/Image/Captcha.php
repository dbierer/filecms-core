...
class Captcha
{
    ...
    public const DEFAULT_ROTATE_MIN       = -33;
    public const DEFAULT_ROTATE_MAX       = 33;
    ...
    public const DEFAULT_LINE_MIN         = 12;
    public const DEFAULT_LINE_MAX         = 24;
    public const DEFAULT_DOT_MIN          = 30;
    public const DEFAULT_DOT_MAX          = 50;
    public const DEFAULT_WAVE_X_AMPLITUDE = 6.0;
    public const DEFAULT_WAVE_Y_AMPLITUDE = 4.0;
